...
function Volunteer() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
     ...
     await axios.post(
        "http://localhost:8000/addVolunteerRequest",
        datas
      );
      ...
      <section className="volunteer-section">
        <div className="auto-container">
          <div className="sec-title text-center">
            ...
            <div className="text">
              Please read below to see what a few of our charity partners have
              to say about us.
            </div>
          </div>
          <div className="row">
            ...
            <div className="col-lg-3 order-lg-2">
              ...
              >
                <div className="row no-gutters justify-content-center align-items-center">
                  <div className="image">
                    <img src="images/resource/image-8.jpg" alt="" />
                  </div>
                </div>
                <div className="row no-gutters justify-content-center align-items-center">
                  <div className="image">
                    <img src="images/resource/image-9.jpg" alt="" />
                  </div>
                  <div className="image">
                    <img src="images/resource/image-10.jpg" alt="" />
                  </div>
                </div>
                <div className="row no-gutters justify-content-center align-items-center">
                  <div className="image">
                    <img src="images/resource/image-11.jpg" alt="" />
                  </div>
                </div>
              </div>
            </div>
